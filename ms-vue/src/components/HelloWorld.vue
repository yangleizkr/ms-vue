<template>
  <div class="hello">
    ...
    <el-form ref="sysUser" :model="form" :rules="rules" label-width="80px" class="login-box">
      ...
      <el-form-item>
        <el-button type="primary" v-on:click="onSubmit('sysUser')">登录</el-button>
      </el-form-item>
    </el-form>
  ...
  methods: {
    onSubmit(formName) {
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          this.$axios.post('sys_user/login',this.form).then(response =>{
